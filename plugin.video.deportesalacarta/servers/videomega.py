...
def get_video_url(page_url, premium=False, user="", password="", video_password=""):
    logger.info("deportesalacarta.servers.videomega get_video_url(page_url='%s')" % page_url)
    ...
    for video_url in video_urls:
        logger.info("deportesalacarta.servers.videomega %s - %s" % (video_url[0], video_url[1]))
