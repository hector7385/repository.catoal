...
def test_video_exists(page_url):
    logger.info("deportesalacarta.servers.datoporn test_video_exists(page_url='%s')" % page_url)
...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    ...
    for video_url in video_urls:
        logger.info("deportesalacarta.servers.datoporn %s - %s" % (video_url[0],video_url[1]))
