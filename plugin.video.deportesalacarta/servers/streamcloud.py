...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    ...
    location = scrapertools.get_header_from_response("https://fr-proxy.zalmos.com/includes/process.php?action=update", post="u=%s" % page_url, header_to_get="location")
    headers.append(['Referer', 'https://fr-proxy.zalmos.com/includes/process.php?action=update'])
    ...
    try:
        ...
        headers[1][1] = location
        data = scrapertools.cache_page( location , post=post, headers=headers)
    ...
    media_url = scrapertools.get_header_from_response("https://fr-proxy.zalmos.com/includes/process.php?action=update", post="u=%s" % media_url, header_to_get="location")
    video_urls = []
