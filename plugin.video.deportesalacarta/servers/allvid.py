...
def test_video_exists( page_url ):
    logger.info("deportesalacarta.servers.allvid test_video_exists(page_url='%s')" % page_url)
...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("deportesalacarta.servers.allvid url="+page_url)
    ...
    for video_url in video_urls:
        logger.info("deportesalacarta.servers.allvid %s - %s" % (video_url[0],video_url[1]))
