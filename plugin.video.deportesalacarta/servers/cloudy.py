...
def test_video_exists( page_url ):
    logger.info("deportesalacarta.servers.cloudy test_video_exists(page_url='%s')" % page_url)
...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    ...
    logger.info("deportesalacarta.servers.clouddy get_video_url(page_url='%s')" % page_url)
