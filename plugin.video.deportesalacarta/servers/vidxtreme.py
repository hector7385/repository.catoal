...
def test_video_exists( page_url ):
    logger.info("deportesalacarta.servers.vidxtreme test_video_exists(page_url='%s')" % page_url)
    return True,""

def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("deportesalacarta.servers.vidxtreme url="+page_url)
...
def find_videos(data):
    ...
    logger.info("deportesalacarta.servers.vidxtreme find_videos #"+patronvideos+"#")
