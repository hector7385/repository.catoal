...
def canales(item):
    ...
    itemlist.append(Item(channel=__channel__, title="[COLOR teal]Elgoles[/COLOR]", action="elgoles", url="http://robertrc.bget.ru/", thumbnail="http://s6.postimg.org/5w3t949ld/streamsportsfutbolthumb.png",fanart="http://s6.postimg.org/sm2y23ssx/streamsportsfutbolfan.jpg", folder=True))
...
def euro(item):
    ...
    data = scrapertools.downloadpage("http://pastebin.com/raw/P0aice5g")
