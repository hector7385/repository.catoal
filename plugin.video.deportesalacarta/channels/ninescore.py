...
def agenda(item):
    ...
    for match in bloque:
        ...
        for liga, hora, minutos, date, team1, team1image, team2, team2image, scrapedurl, live in matches:
            ...
            hora_partido = fecha_partido + datetime.timedelta(hours=1)
            ...
            try:
                scrapedthumbnail = "http://www.myfootball.ws/DPYrOE/table/new2/" + thumbs[liga]+".png"
            except:
                pass
