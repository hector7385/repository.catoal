...
def mainlist(item):
    logger.info("deportesalacarta.channels.fullmatchtv mainlist")
    itemlist = []
...
def search(item,texto):
    logger.info("deportesalacarta.channels.fullmatchtv search")
    itemlist = []
    item.url = "http://fullmatchtv.com/?s=" + texto
    return busqueda(item)

def novedades(item):
    logger.info("deportesalacarta.channels.fullmatchtv novedades")
    itemlist = []
...
def categorias(item):
    logger.info("deportesalacarta.channels.fullmatchtv categorias")
    itemlist = []
...
def busqueda(item):
    logger.info("deportesalacarta.channels.fullmatchtv busqueda")
    itemlist = []
    data = scrapertools.cachePage(item.url)
    data = scrapertools.decodeHtmlentities(data)
