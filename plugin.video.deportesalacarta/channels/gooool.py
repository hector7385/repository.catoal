...
def mainlist(item):
    logger.info("deportesalacarta.channels.gooool mainlist")
    itemlist = []
...
def agenda(item):
    logger.info("deportesalacarta.channels.gooool agenda")
    itemlist = []
    ...
    for dia, mes, bloque in bloques:
        ...
        for hora, thumbnail, url, partido in matches:
            ...
            fecha_partido = fecha_partido - datetime.timedelta(hours=2)
...
def futbol(item):
    logger.info("deportesalacarta.channels.gooool futbol")
    itemlist = []
...
def deportes(item):
    logger.info("deportesalacarta.channels.gooool deportes")
    itemlist = []
...
def videos(item):
    logger.info("deportesalacarta.channels.gooool videos")
    itemlist = []
...
def findlives(item):
    logger.info("deportesalacarta.channels.gooool findlives")
    itemlist = []
...
def play(item):
    logger.info("deportesalacarta.channels.gooool play")
    itemlist = []
...
def translate(url_translate):
    ...
    data = dhe( scrapertools.downloadpage(url,follow_redirects=False) )
    ## Petición 2
