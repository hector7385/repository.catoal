...
def findvideos(data):
    logger.info("deportesalacarta.core.servertools findvideos") # en #"+data+"#")
    encontrados = set()
    devuelve = []
    ...
    import time
    from servers import prueba
    inicio = time.clock()
    #devuelve = prueba.find_videos(data, server_list)

    #Descargado en 1.922683 segundos
    #Descargado en 4.587262 segundos
    ...
    for serverid in server_list:
        ...
        try:
            ...
            logger.info(traceback.format_exc())
    fin = time.clock()
    logger.info("Descargado en %f segundos " % (fin - inicio))
