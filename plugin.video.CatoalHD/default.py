...
addon_id = 'plugin.video.CatoalHD'
selfAddon = xbmcaddon.Addon(id=addon_id)

#addon = Addon('plugin.video.CatoalHD', sys.argv)
#net = Net()
...
print paramstring
name='Catoal[COLOR lime]HD[/COLOR]'
proxy_string=None
...
def playF4mLink(url,name='Catoal[COLOR lime]HD[/COLOR]',proxy=None,use_proxy_for_chunks=False,auth_string=None,streamtype='HDS',setResolved=False,swf=""):
